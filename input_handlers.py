...
"""An event handler return value which can trugger an action or switch active handlers.
...
class LevelUpEventHandler(AskUserEventHandler):
  ...
  def ev_mousebuttondown(
    ...
    """Don't permit the player to exit the menu per normal"""
    return None
...
class AreaRangedAttackHandler(SelectIndexHandler):
  """Handles targetting an area within a given radius. Any entity within will be affected."""
  def __init__(
      self,
      engine: Engine,
      radius: int,
